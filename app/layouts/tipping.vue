...
.is-layout-tipping
  div(class='md:flex md:flex-row')
    header.hidden.space-y-4.border-r(
      class='w-[15%] min-w-[10rem] bg-neutral-50/50 md:block dark:border-gray-700 dark:bg-gray-900'
    )
      .space-y-1.p-4
    ...
    header.sticky.top-0.z-10.bg-white(class='md:hidden dark:bg-neutral-800')
