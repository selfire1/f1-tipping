      ...
      template(v-else)
          ...
          UCard
            ...
            .space-y-4
              .relative.overflow-hidden.py-4.-mx-6.-mt-6
                NuxtImg.pointer-events-none.opacity-5.h-full.w-full.object-cover.inset-0.absolute(:src="COUNTRY_FLAGS[nextRace.country]")
                .px-6
        ...
        template(v-if="championshipCutoffDate && isFuture(championshipCutoffDate)")
          UCard
            ...
            .space-y-4
              .relative.overflow-hidden.py-4.-mx-6.-mt-6
                NuxtImg.pointer-events-none.opacity-5.h-full.w-full.object-cover.inset-0.absolute(src="https://images.unsplash.com/photo-1514820720301-4c4790309f46?q=80&w=1332&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")
                .px-6
